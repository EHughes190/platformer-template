...
export class Player {
    ...
    setState(state) {
        ...
        console.log(this.currentState, this.vy, this.isGrounded(), this.coyoteTimeCounter);
    }
    ...
    colCheck(shapeA, shapeB) {
        ...
        let vX = shapeA.x + shapeA.width / 2 - (shapeB.x + shapeB.width / 2), vY = shapeA.y + shapeA.height / 2 - (shapeB.y + shapeB.height / 2), 
        // add the half widths and half heights of the objects
        hWidths = shapeA.width / 2 + shapeB.width / 2, hHeights = shapeA.height / 2 + shapeB.height / 2;
